...
class Cmsmart_Deliverydate_Block_Adminhtml_Deliverydate_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if( Mage::registry('deliverydate_data') && Mage::registry('deliverydate_data')->getId() ) {
            return Mage::helper('deliverydate')->__("Edit", $this->htmlEscape(Mage::registry('deliverydate_data')->getTitle()));
        } else {
            return Mage::helper('deliverydate')->__('Add');
        }
    }
}
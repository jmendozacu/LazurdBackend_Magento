...
class Cmsmart_Deliverydate_Adminhtml_DeliverydateController extends Mage_Adminhtml_Controller_action
{
...
//                        $fromtime = $data['hours'].":".$data['minutes'].":".$data['seconds'];
//                        $totime = $data['hours1'].":".$data['minutes1'].":".$data['seconds1'];
//

<?php
class Ewall_CustomConfig_Model_Resource_Product_Collection extends Mage_Catalog_Model_Resource_Product_Collection
{
    // public function addKitchenOrderedQty($from = '', $to = '')
    // {
    //     echo 'hlllo';exit();

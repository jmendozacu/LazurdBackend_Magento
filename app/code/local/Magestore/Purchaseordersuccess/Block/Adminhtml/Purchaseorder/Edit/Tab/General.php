...
class Magestore_Purchaseordersuccess_Block_Adminhtml_Purchaseorder_Edit_Tab_General extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $data['currency_code'] = isset($data['currency_code']) ? $data['currency_rate'] : Mage::app()->getLocale()->getCurrency();
        $data['currency_rate'] = !isset($data['currency_rate']) ? '1' : $data['currency_rate'];

...
abstract class Magestore_Webpos_Service_Abstract extends Varien_Object
{
    ...
    protected function _assignQuoteToStaff($quoteData){
        ...
        if($sessionModel && $sessionModel->getId()){
            //Islam Elgarhy Session for refund cashdrawer
            // old without comment $sessionModel->setCurrentTillId((!empty($quoteData[Magestore_Webpos_Api_Cart_QuoteDataInitInterface::TILL_ID]))?$quoteData[Magestore_Webpos_Api_Cart_QuoteDataInitInterface::TILL_ID]:0);

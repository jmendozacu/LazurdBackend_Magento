    ...
    public function getShipping(){
        ...
        if(count($list) > 0){
            ...
            foreach ($list as $data) {
                ...
                $minOrderAmount = $data['carrierMinOrderAmount'];

                // $tot = getTotals();
                // Mage::log('carr '.$tot ,null,'mylog3.log');

                // if($total >= intval($minOrderAmount) ) {
                //     $methodPrice = '0';
                //     Mage::log('iam here',null,'mylog3.log');
                // }
                // Mage::log('carr '.$minOrderAmount ,null,'mylog3.log');
                ...
                // Edit by ryan 22032018
                $shippingModel->setMinOrderAmount($minOrderAmount);

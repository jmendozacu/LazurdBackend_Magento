    ...
    public function dispatch()
    {
        ...
        switch ($this->getActionType()) {
            case self::ACTION_SAVE_CART:
				...
				if(($customerData['shipping_address']['region_id']==0) && ($customerData['shipping_address']['region']['region_id']!=0))
				{
					$customerData['shipping_address']['region_id']=$customerData['shipping_address']['region']['region_id'];
					$customerData['billing_address']['region_id']=$customerData['shipping_address']['region']['region_id'];
				}
			    //echo "<pre>"; print_r($this->_service);			  exit;

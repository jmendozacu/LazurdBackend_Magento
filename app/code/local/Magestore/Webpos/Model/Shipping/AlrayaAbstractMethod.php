...
abstract class Magestore_Webpos_Model_Shipping_AlrayaAbstractMethod extends Mage_Shipping_Model_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface {

    protected $_method_code = '';

    protected $_code = 'webpos_pickup_alraya';

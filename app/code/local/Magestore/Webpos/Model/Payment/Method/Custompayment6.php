...
class Magestore_Webpos_Model_Payment_Method_Custompayment6 extends Mage_Payment_Model_Method_Abstract {
    /* This model define payment method */
    
    protected $_code = 'cp6forpos';
    protected $_infoBlockType = 'webpos/payment_method_cc_info_cp6';
    ...
    public function isAvailable($quote = null) {
        ...
        $ccenabled = Mage::helper('webpos/payment')->iscp6PaymentEnabled();

...
class Magestore_Webpos_Model_Payment_Method_Custompayment3 extends Mage_Payment_Model_Method_Abstract {
    /* This model define payment method */
    
    protected $_code = 'cp3forpos';
    protected $_infoBlockType = 'webpos/payment_method_cc_info_cp3';
    ...
    public function isAvailable($quote = null) {
        ...
        $ccenabled = Mage::helper('webpos/payment')->isCp3PaymentEnabled();

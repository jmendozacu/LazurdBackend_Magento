...
class Magestore_Webpos_Block_Adminhtml_User_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection->getSelect()
                ->joinLeft(array('location_table' => Mage::getModel('core/resource')->getTableName('webpos/userlocation')), 'main_table.location_id=location_table.location_id', array('location_table.display_name as location_table.display_name'));

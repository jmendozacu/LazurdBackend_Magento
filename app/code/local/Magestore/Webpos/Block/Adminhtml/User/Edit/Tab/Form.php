    ...
    protected function _prepareForm() {
        ...
        if (!Mage::app()->isSingleStoreMode()) {
            $fieldset->addField('store_id', 'multiselect', array(
                ...
                'title' => Mage::helper('webpos')->__('Store View'),
                'required' => true,
       ...
       //nnnnnnn2018
        ...
        $fieldset->addField('head_user_id', 'select', array(
            'label' => Mage::helper('webpos')->__('Supervisor User'),
            'name' => 'head_user_id',
            'values' => Mage::getSingleton('webpos/user')->toOptionArray()
        ));

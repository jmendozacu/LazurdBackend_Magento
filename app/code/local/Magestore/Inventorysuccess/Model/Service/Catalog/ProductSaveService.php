...
class Magestore_Inventorysuccess_Model_Service_Catalog_ProductSaveService
{
    ...
    protected function _updateStockItem($product)
    {
        ...
        $stockStatusData = array('stock_status' => $item->getIsInStock());
        $this->stockRegistryService->cloneStockStatus($product->getId(), $stockStatusData, array(), array($this->stockService->getGlobalStockId()));
    }    

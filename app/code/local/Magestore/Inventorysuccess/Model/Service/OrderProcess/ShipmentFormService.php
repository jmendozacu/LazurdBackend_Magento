...
class Magestore_Inventorysuccess_Model_Service_OrderProcess_ShipmentFormService
{
    ...
    public function getAvailableWarehouses($order)
    {
        ...
        $whProducts = $this->stockRegistryService->getStocksFromEnableWarehouses(array_keys($needToShipItems));
        ...
        $warehouseList = $this->warehouseService->getWarehouses($warehouseIds, self::CREATE_SHIPMENT_ACL_RESOURCE);

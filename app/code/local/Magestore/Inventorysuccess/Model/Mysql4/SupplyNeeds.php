...
//        }
        /** @var Magestore_Inventorysuccess_Model_Mysql4_Warehouse_Shipment_Item_Collection $collection */
        $collection = Mage::getResourceModel('inventorysuccess/warehouse_shipment_item_collection');

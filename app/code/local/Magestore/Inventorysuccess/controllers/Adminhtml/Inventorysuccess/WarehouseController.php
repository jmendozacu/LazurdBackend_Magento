...
class Magestore_Inventorysuccess_Adminhtml_Inventorysuccess_WarehouseController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function deleteAction()
    {
        ...
        try {
            Mage::getModel('inventorysuccess/warehouse')->load($warehouseId)->delete();
    ...
    public function exportCsvAction()
    {
        ...
        $content = $this->getLayout()->createBlock('inventorysuccess/adminhtml_warehouse_grid')->getCsvFile();

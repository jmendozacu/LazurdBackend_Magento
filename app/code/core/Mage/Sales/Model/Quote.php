...
class Mage_Sales_Model_Quote extends Mage_Core_Model_Abstract
{
    ...
    public function addProductAdvanced(Mage_Catalog_Model_Product $product, $request = null, $processMode = null)
    {
        ...
        /*Edit by 24122017 Islam ELgarhy*/
            ...
            $discount_cause = $request->getData('discount_cause');
            if($discount_cause != "" && $discount_cause != NULL)
                $item->setdiscount_cause($discount_cause);
            $discount_by = $request->getData('discount_by');
                if($discount_by != "" && $discount_by != NULL)
                    $item->setdiscount_by($discount_by);

...
define(
    ...
    function ($, ko, CartModel, DiscountModel, HelperPrice, OrderHelper, Staff, DateTime, Event, Totals, Helper, Alert, OrderFactory, CheckoutResource, CreditCard, DataManager, AddNoti, Tills) {
        "use strict";

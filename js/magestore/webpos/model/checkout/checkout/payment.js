                ...
                Event.observer('load_payment_online_after', function (event, data) {
                    ...
                    if (data && data.items) {
                        ...
                        if (!CartModel.isGift()) {
                            ...
                            // Begin for cash on dlivery on gift orders
                            var index = posPayments.findIndex(x => x.code == "codforpos");
                            if (index != undefined && index != -1)
                                posPayments.splice(index, 1); 
                            // End for cash on dlivery on gift orders

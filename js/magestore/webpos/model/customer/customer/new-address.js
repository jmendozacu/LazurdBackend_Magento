...
define(
    ...
    function ($, ko, helper, currentCustomer, editCustomer) {
        ...
        return {
            ...
            vatId: ko.observable(''),
            receiver_name: ko.observable(''),
            is_gift: ko.observable('1'),
            ...
            getAddressData: function () {
                ...
                data.is_gift = self.is_gift();
                data.is_gift =  document.forms['form-customer-add-address-checkout'].elements['is_gift'].value;

...
define(
    ...
    function ($, ko, helper) {
        ...
        return {
            ...
            previewBillingReceiverName: ko.observable(''),
			previewBillingIsGift: ko.observable(''),
            ...
            previewShippingReceiverName: ko.observable(''),
			previewShippingIsGift: ko.observable(''),
			...
			//	alert("bbb" + data.receiver_name);
                ...
                this.previewBillingReceiverName(data.receiver_name);
				this.previewBillingIsGift(data.is_gift);
            },

            /* Set Data for shipping preview */
            setShippingPreviewData: function (data) {
				//alert("aaa" + data.receiver_name);
                ...
                this.previewShippingReceiverName(data.receiver_name); 
				this.previewShippingIsGift(data.is_gift);
            },

...
define([
    ...
    return {
        ...
        getStaffResourceAccessOriginal : getStaffResourceAccessOriginal,
        setStaffResourceAccessOriginal : setStaffResourceAccessOriginal,
        setStaffResourceAccess :setStaffResourceAccess,
    };
    ...
    function getStaffResourceAccessOriginal () {
        return currentStaff.getStaffResourceAccessOriginal();
    }
    function setStaffResourceAccessOriginal(resource) {
        currentStaff.setStaffResourceAccessOriginal(resource);
    }
    function setStaffResourceAccess (resource) {
        return currentStaff.setStaffResourceAccess(resource);
    }

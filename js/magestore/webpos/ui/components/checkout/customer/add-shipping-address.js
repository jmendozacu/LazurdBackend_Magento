            ...
            saveShippingAddress: function () {
                ...
                if (this.validateShippingAddressForm()) {
                    ...
                    if(!document.getElementById("email").value || document.getElementById("email").value == 'undefined') {
	                    ...
	                    // if(this.phoneShipping() != "" && this.phoneShipping() != 'undefined') {
	                    // 	document.getElementById("email").value = this.phoneShipping() + '@'+domain;
                        // }
                        debugger;
                    ...
                    if(this.phoneShipping() != "" && ((!document.getElementById("first-name").value) || document.getElementById("first-name").value == 'undefined')) {
                		document.getElementById('first-name').value = this.phoneShipping();
                		document.getElementById('shipping_first-name').value = this.phoneShipping();
                    }
                    if(this.phoneShipping() != "" && ((!document.getElementById("last-name").value) || document.getElementById("last-name").value == 'undefined')) {
                    	document.getElementById('last-name').value = '.';
                    	document.getElementById('shipping_last-name').value = '.';
                    }

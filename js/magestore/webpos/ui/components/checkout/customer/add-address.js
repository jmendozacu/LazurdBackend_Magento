    ...
    function (
        ...
        return Component.extend({
            ...
            zipcode: ko.pureComputed(function () {
                //console.log(newAddressModel);
                return newAddressModel.zipcode();
            }),
            vatId: ko.pureComputed(function () {
                return newAddressModel.vatId();
            }),
            is_gift: ko.pureComputed(function () {
                return newAddressModel.is_gift();
            }),
            receiver_name: ko.pureComputed(function () {
                return newAddressModel.receiver_name();
            }),
            ...
            setVat: function(data,event) {
                newAddressModel.vatId(event.target.value);
            },
            setIsGift: function(data,event) {
                newAddressModel.is_gift(event.target.value);
            },
            setReceiverName: function(data,event) {
                newAddressModel.receiver_name(event.target.value);
            }

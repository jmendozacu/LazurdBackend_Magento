    ...
    function (
        ...
        return Component.extend({
            ...
            phone: ko.pureComputed(function () {
                return editCustomerModel.phone();
            }),
            dob: ko.pureComputed(function () {

                var date = new Date(editCustomerModel.dob());
            ...
            initialize: function () {
                ...
                self.addressArrayDisplay = ko.pureComputed(function () {
                    ...
                    ko.utils.arrayMap(editCustomerModel.addressArray(), function (item) {
                        // if ((item.is_gift != '1'  && !self.isGiftP() ) || (item.is_gift == '1' && self.isGiftP() ) )
                        if ( item.is_gift != '1' )
                    ...
                    // debugger
                    // newAddressArray = newAddressArray.addFieldToFilter('is_gift', '1', 'eq');
            ...
            loadData: function (data) {
                ...
                editCustomerModel.dob(data.dob);
                editCustomerModel.phone(data.phone);
            ...
            showAddress: function () {
                ...
                document.forms['form-customer-add-address-checkout'].elements['is_gift'].value = 0;
            ...
            setDob: function (data, event) {
                editCustomerModel.dob(event.target.value);
            },
            setPhone: function (data, event) {
                editCustomerModel.phone(event.target.value);
            }
        });
    }
);
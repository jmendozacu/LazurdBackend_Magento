    ...
    function ($, ko, Component, billingAddressModel, shippingAddressModel, helper) {
        ...
        return Component.extend({
            ...
            saveBillingAddress: function () {
                ...
                if (this.validateBillingAddressForm()) {
                    ...
                    if(!document.getElementById("first-name").value || document.getElementById("first-name").value == 'undefined') {
                    	document.getElementById("first-name").value = this.firstNameBilling();
                    }
                    // if(!document.getElementById("last-name").value || document.getElementById("last-name").value == 'undefined') {
                    // 	document.getElementById("last-name").value = this.lastNameBilling();
                    // }
                    if(!document.getElementById("add-customer-phone").value || document.getElementById("add-customer-phone").value == 'undefined') {
                    	document.getElementById("add-customer-phone").value = this.phoneBilling();
                    }
	                ...
	                //     if(this.phoneBilling() != "" && this.phoneBilling() != 'undefined') {
	                //     	document.getElementById("email").value = this.phoneBilling() + '@'+domain;
	                //     }
                    // }
                    
                    if(this.phoneBilling() != "" && ((!document.getElementById("first-name").value) || document.getElementById("first-name").value == 'undefined')) {
                		document.getElementById('first-name').value = this.phoneBilling();
                		document.getElementById('billing_first-name').value = this.phoneBilling();
                    }
                    if(this.phoneBilling() != "" && ((!document.getElementById("last-name").value) || document.getElementById("last-name").value == 'undefined')) {
                    	document.getElementById('last-name').value = '.';
                    	document.getElementById('billing_last-name').value = '.';
                    }
            ...
            resetFormInfo: function () {
                ...
                billingAddressModel.countryBilling('');

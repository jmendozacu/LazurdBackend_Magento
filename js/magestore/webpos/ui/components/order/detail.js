    ...
    function (
        ...
        return Component.extend({
            ...
            initialize: function () {
                ...
                ko.pureComputed(function () {
                    ...
                    if (self.orderData()) {
                        ...
                        //Edit by 17032018 Islam ELgarhy
                        self.canEdit(orderModel.setData(self.orderData()).canEdit());
                        //Edit by 17032018 Islam ELgarhy
            ...
            getCustomerName: function (type) {
                ...
                return (address.firstname ? address.firstname : "" + ' ' + address.lastname ? address.lastname : "");
            },
            ...
            getStatus: function () {
                ...
                return _.find(self.statusObject, function (obj) {
                   // OrderStatus&State&Status Islam Elgarhy
                    ...
                    return obj.statusClass == self.orderData().order_status
              // OrderStatus&State&Status Islam Elgarhy
                }).statusLabel;
            },
            ...
            GotoOrderListInMobile: function () {
                //1012018islam
                $("#webpos_order_view_container").hide();
                $("#webpos_order_list").show();
            ...
            printOrder: function () {
                ...
                /*
                Test Print All Invoices Islam ELgarhy
                debugger;
                var allX = $(".list-orders").find("li");
                var html ="";
                $.each(allX,function(i,x){
                    x.click();
                    html += $('#container-print-order')[0].innerHTML;
                });
            ...
            editOrder: function () {
                ...
                editcart.emptyCartItems(); //iis 2018    
                // Islam Elgarhy For Edit Order 7/2018
                this.isShowActionPopup(false);
                ReOrder(this.orderData());
                // eventmanager.dispatch('show_cart_discount_popup', '');
                // Islam Elgarhy For Edit Order 7/2018
                //eventmanager.dispatch('apply_from_edit', '');
                // Islam Elgarhy For Edit Order 7/2018
                window.webposConfig["OrderIsEdit"] = true;
                window.webposConfig["OrderIsEditId"] = this.orderData().entity_id;
                if(this.orderData().base_discount_amount && this.orderData().base_discount_amount < 0 )
                {
                    window.webposConfig["editedORderDiscount"] = Math.abs(this.orderData().base_discount_amount);
                }

        ...
        return listAbstract.extend({
            ...
            _prepareCollection: function () {
                ...
                if (this.statusArray.length > 0) {
                    ...
                    this.collection.addFieldToFilter('order_status', this.statusArray, 'in');
                    // OrderStatus&State&Status Islam Elgarhy
                ...
                {
                    // Islam Kuywait 2018
                    this.collection.addFieldToFilter('order_status', 'canceled', 'neq');
                }
                // else {
            ...
            GotoOrderDetailInMobile: function () {
                //1012018islam
                $("#webpos_order_list").hide();
                $("#webpos-notification").hide();
                $(".show-menu-button").hide();
                $("#webpos_order_view_container").show();

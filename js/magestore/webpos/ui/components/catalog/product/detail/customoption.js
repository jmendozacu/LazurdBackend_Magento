                ...
                $.each(customOptions, function (index, value) {
                    ...
                    if (value.type == 'field' || value.type == 'area') {
                        ...
                        if (selectionArr.length > 0)
                            customOptionsValueResult.push({id: value.option_id, value: selectionArr, optionTitle: value.title});
                            //customOptionsValueResult[value.option_id] = selectionArr;
                        if (lableString.length >0 )
                            customOptionsLableResult.push({id: value.option_id, value: lableString, optionTitle: value.title });
                    }
                    ...
                    if (value.type == 'drop_down') {
                        if (($("#select_" + value.option_id).length > 0)
                            ...
                            if (selectionArr.length > 0)
                                customOptionsValueResult.push({id: value.option_id, value: selectionArr, title: value.default_title});
                                //customOptionsValueResult[value.option_id] = selectionArr;
                            if (lableString.length >0 )
                                customOptionsLableResult.push({id: value.option_id, value: lableString, title: value.default_title});
                        }
                    }

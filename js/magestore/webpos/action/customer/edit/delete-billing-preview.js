            ...
            Confirm({
                ...
                actions: {
                    confirm: function () {
                        ...
                        var currentPhone = currentData.phone;
                        var customerCollection;
                        if (generalHelper.isOnlineCheckout()) {
                            customerCollection = CustomerFactory.get().setMode('online').getCollection().addFieldToFilter('phone', currentPhone, 'eq')
                                .load();
                        } else{
                            customerCollection = CustomerFactory.get().setMode('offline').getCollection().addFieldToFilter('phone', currentPhone, 'eq')
                                .load();
                        }

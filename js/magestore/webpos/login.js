        ...
        ajaxLogin: function () {
            ...
            deferred.done(function (data) {
                if (data != false) {
                    ...
                    var backorderConfig = data.webpos_config["cataloginventory/item_options/backorders"];
                    ...
                    //islam
                    Helper.saveLocalConfig('currstoreId', $('#select_store').val());
                    //Ryan
                    Helper.saveLocalConfig('backorderConfig', backorderConfig);
                    //end of islam & Ryan
